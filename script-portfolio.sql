...
INSERT INTO `portfolio-database`.`education` (`id`, `thumb`, `institution`, `title`, `details`, `from_date`, `to_date`, `user_id`) VALUES ('1', '../assets/images/education/arg.png', 'Argentina Programa', 'Etapa 1 #SeProgramar y Etapa 2 #YoProgramo.', 'Fundamentos, programación imperativa y orientada a objetos. Arquitectura web, gestión de tiempo, SCRUM, GitFlow, HTML, CSS, JS, Bootstrap, TypeScript, SPA, MVC, Angular, Bases de Datos Relacionales, UML, POO, patrones de diseño, Java, Spring Boot, Dev Ops, comunicación efectiva.', '2021.10', '2022.08', '1');
...
INSERT INTO `portfolio-database`.`education` (`id`, `thumb`, `institution`, `title`, `details`, `from_date`, `to_date`, `user_id`) VALUES ('10', '../assets/images/education/utn.png', 'UTN Extensión Universitaria', 'Professional Webmaster. Desarrollo web con JavaScript. Desarrollo Avanzado con JS, JQuery y JSON. Fundamentos de la Programación.', 'Protocolos, browsers, DNS, dominios, ISPs, hosting. Illustrator y Photoshop. HTML / CSS. SEO. ProgramacProfessional Webmaster. Desarrollo web con JavaScript. Desarrollo Avanzado con JS, JQuery y JSON. Fundamentos de la Programación.ión, tipos, algoritmos, metodología, lenguajes, servidores y plataformas. DB relacionales. Modelos de datos. Servidores locales. PHP. MySQL. JavaScript. Librerías. Funciones. Eventos. Estructuras de control de flujo, funciones y propiedades. Principios POO. Prototipos, funciones, eventos. DOM, BOM. Librerías y frameworks. Manipulación del DOM y nodos. Elementos, atributos, estilos. Jerarquías, selectores, atributos, funciones, métodos, eventos, objetos. JSON. AJAX. Lenguajes y paradigmas. Algoritmos, lógica, seudocódigo y diagramas. Variables y tipos. Estructura de datos. POO.', '2010', '2014', '1');
